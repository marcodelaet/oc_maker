/** @typedef {{ codigo: string, rede: string, insercoes: number, impactos: number, bruto: number, liquido: number }} InventoryRow */
/** @typedef {{ ads_id: string, agencia: string, anunciante: string, planejador: string, campanha: string, inicio: string|null, termino: string|null, inventory: InventoryRow[], observacoes: string[] }} CampaignData */
